...
BASE_INSTRUCTIONS = (
    ...
    "get_hunger_map_context tool. Use 'global' for the headline or all available "
    "country estimates. Continue using "
    ...
    "crisis reports. "
    "For aid, development, or humanitarian activities published to IATI, use "
    "search_iati_activities. Use get_iati_activity with an activity ID returned "
    "by that search when core details or source documents are needed. "
